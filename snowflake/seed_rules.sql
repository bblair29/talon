...
SELECT 'scalper', 'ScalperRule', TRUE,
...
INSERT INTO RULES (name, type, enabled, description, config)
SELECT 'vwap_reversion', 'VWAPMeanReversionRule', TRUE,
...
INSERT INTO RULES (name, type, enabled, description, config)
SELECT 'momentum_pnl', 'MomentumPnLRule', TRUE,
...
INSERT INTO RULES (name, type, enabled, description, config)
SELECT 'rsi_oversold_trailing', 'RSIPnLRule', FALSE,
